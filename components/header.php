          ...
          <div class="dropdown" id="preventDropdown">
            ...
            <ul class="dropdown-menu menuDropdown" aria-labelledby="dropdownMenuLink">
              <li class="accordion" id="menuAccordion">
                ...
                <a class="dropdown-item menuHeadingThree active" type="button" data-bs-toggle="collapse" data-bs-target="#menuCollapseThree" aria-expanded="false" aria-controls="menuCollapseThree"><i class="fas fa-tasks"></i>Collapsible #3</a>
                <div id="menuCollapseThree" class="collapse" aria-labelledby="menuHeadingThree" data-bs-parent="#menuAccordion">
                  <ul>
                    <li><a class="dropdown-item" href="#">Action</a></li>
                    <li><a class="dropdown-item" href="#">Action</a></li>
                    <li><a class="dropdown-item" href="#">Action</a></li>
                ...
                <a class="dropdown-item menuHeadingFour" type="button" data-bs-toggle="collapse" data-bs-target="#menuCollapseFour" aria-expanded="false" aria-controls="menuCollapseFour"><i class="fas fa-bell"></i>Collapsible #4</a>
                <div id="menuCollapseFour" class="collapse" aria-labelledby="menuHeadingFour" data-bs-parent="#menuAccordion">
                  <ul>
                    <li><a class="dropdown-item" href="#">Action</a></li>
                    <li><a class="dropdown-item" href="#">Action</a></li>
                    <li><a class="dropdown-item" href="#">Action</a></li>
